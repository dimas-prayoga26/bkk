@extends('pages.users.pelamar.edit.index', ['subtitle' => 'Edit Foto'])
...
<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
  ...
  <form action="{{ route('user.pelamar.update', [$pelamar, 'foto']) }}" method="POST" enctype="multipart/form-data" id="update-foto">
  @csrf
  @method('PUT')
      ...
      <div class="row mb-6">
        ...
        <div class="col-lg-8">
          <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(assets/media/avatars/blank.png)">
            ...
            <a href="{{ route('user.pelamar.deletefoto', $pelamar) }}" id="delete-foto">

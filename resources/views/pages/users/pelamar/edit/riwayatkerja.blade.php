@extends('pages.users.pelamar.edit.index', ['subtitle' => 'Riwayat Kerja'])
...
@section('js')
  ...
  $(document).ready(function(){
    ...
    $('#riwayat-kerja-table').dataTable({
      ...
      ordering: false,
      ajax: {
        url: '/pelamar/{{ $pelamar->idt }}/edit/riwayatkerja'
      },
      columns:[
    ...
    function store(){
      $.ajax({
        url: '/pelamar/{{ $pelamar->idt }}/riwayatkerja',
        type: 'POST',
        data: {
    ...
    function update(id){
      $.ajax({
        url: '/pelamar/' + id + '/riwayatkerja/update',
        type: 'PUT',
        data: {

@extends('pages.users.pelamar.edit.index', ['subtitle' => 'Berkas'])
        ...
        <tr>
          ...
          <td>
            <div class="btn-group">
              ...
              @if ($pelamar->berkas->surat_lamaran !== null)
                <button type="button" class="btn btn-delete-berkas btn-sm btn-danger px-4 mx-1" data-action="/pelamar/{{ $pelamar->idt }}/berkas/surat_lamaran" data-berkas="Berkas Surat Lamaran">
        ...
        <tr>
          ...
          <td>
            <div class="btn-group">
              ...
              @if ($pelamar->berkas->cv !== null)
                <button type="button" class="btn btn-delete-berkas btn-sm btn-danger px-4 mx-1" data-action="/pelamar/{{ $pelamar->idt }}/berkas/cv" data-berkas="Berkas CV">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                    <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
                  </svg>
                  Hapus
        ...
        <tr>
          ...
          <td>
            <div class="btn-group">
              ...
              @if ($pelamar->berkas->ktp !== null)
                <button type="button" class="btn btn-delete-berkas btn-sm btn-danger px-4 mx-1" data-action="/pelamar/{{ $pelamar->idt }}/berkas/ktp" data-berkas="Berkas KTP">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                    <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
                  </svg>
                  Hapus
        ...
        <tr>
          ...
          <td>
            <div class="btn-group">
              ...
              @if ($pelamar->berkas->ijazah !== null)
                <button type="button" class="btn btn-delete-berkas btn-sm btn-danger px-4 mx-1" data-action="/pelamar/{{ $pelamar->idt }}/berkas/ijazah" data-berkas="Berkas Ijazah">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                    <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
                  </svg>
                  Hapus
        ...
        <tr>
          ...
          <td>
            <div class="btn-group">
              ...
              @if ($pelamar->berkas->skck !== null)
                <button type="button" class="btn btn-delete-berkas btn-sm btn-danger px-4 mx-1" data-action="/pelamar/{{ $pelamar->idt }}/berkas/skck" data-berkas="Berkas SKCK">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                    <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
                  </svg>
                  Hapus
        ...
        <tr>
          ...
          <td>
            <div class="btn-group">
              ...
              @if ($pelamar->berkas->sertifikat_keahlian !== null)
                <button type="button" class="btn btn-delete-berkas btn-sm btn-danger px-4 mx-1" data-action="/pelamar/{{ $pelamar->idt }}/berkas/sertifikat_keahlian" data-berkas="Berkas Sertifikat Keahlian DLL">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                    <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
                  </svg>
                  Hapus
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
        <div class="modal-header">
         ...
         <form action="{{ route('user.pelamar.update', [$pelamar, 'berkas']) }}" method="POST" enctype="multipart/form-data" id="form-edit-ktp">
          @csrf
          @method('PUT')
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
        <div class="modal-header">
         ...
         <form action="{{ route('user.pelamar.update', [$pelamar, 'berkas']) }}" method="POST" enctype="multipart/form-data" id="form-edit-ijazah">
          @csrf
          @method('PUT')
            <div class="modal-body">
              <div class="d-flex flex-column mb-4 fv-row">
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
        <div class="modal-header">
         ...
         <form action="{{ route('user.pelamar.update', [$pelamar, 'berkas']) }}" method="POST" enctype="multipart/form-data" id="form-edit-surat_lamaran">
          @csrf
          @method('PUT')
            <div class="modal-body">
              <div class="d-flex flex-column mb-4 fv-row">
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
        <div class="modal-header">
         ...
         <form action="{{ route('user.pelamar.update', [$pelamar, 'berkas']) }}" method="POST" enctype="multipart/form-data" id="form-edit-cv">
          @csrf
          @method('PUT')
            <div class="modal-body">
              <div class="d-flex flex-column mb-4 fv-row">
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
        <div class="modal-header">
         ...
         <form action="{{ route('user.pelamar.update', [$pelamar, 'berkas']) }}" method="POST" enctype="multipart/form-data" id="form-edit-skck">
          @csrf
          @method('PUT')
            <div class="modal-body">
              <div class="d-flex flex-column mb-4 fv-row">
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
        <div class="modal-header">
         ...
         <form action="{{ route('user.pelamar.update', [$pelamar, 'berkas']) }}" method="POST" enctype="multipart/form-data" id="form-edit-sertifikat_keahlian">
          @csrf
          @method('PUT')
            <div class="modal-body">
              <div class="d-flex flex-column mb-4 fv-row">

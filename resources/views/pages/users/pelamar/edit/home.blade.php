@extends('pages.users.pelamar.edit.index', ['subtitle' => 'Detail'])
...
<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
  ...
  <div class="card-body">
    ...
    <div class="d-flex flex-stack fs-4 py-3">
      <div class="fw-bolder rotate collapsible" data-bs-toggle="collapse" href="#riwayat_lamaran" role="button" aria-expanded="false" aria-controls="riwayat_lamaran">Riwayat Lamaran
    ...
    <div id="riwayat_lamaran" class="collapse show">
            ...
            <tbody class="ps-3">
              @foreach ($riwayatLamaran as $item)
                <tr class="border-bottom">
                  ...
                  <td>
                    <a href="{{ route('user.loker.show', $item->loker->idt) }}" class="btn btn-sm btn-success btn-show px-4 mx-1">
    ...
    <div class="d-flex flex-stack fs-4 py-3 mt-3">
      ...
      <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit">
        <a href="{{ route('user.pelamar.edit', [$pelamar, 'data']) }}" class="btn btn-sm btn-primary">Edit</a>
      </span>
    </div>
    <div class="separator"></div>
    ...
    <div class="d-flex flex-stack fs-4 py-3 mt-3">
      ...
      <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit">
        <a href="{{ route('user.pelamar.edit', [$pelamar, 'riwayatkerja']) }}" class="btn btn-sm btn-primary">Edit</a>
      </span>
    </div>
    <div class="separator"></div>
    ...
    <div class="d-flex flex-stack fs-4 py-3 mt-3">
      ...
      <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit">
        <a href="{{ route('user.pelamar.edit', [$pelamar, 'berkas']) }}" class="btn btn-sm btn-primary">Edit</a>
      </span>
    </div>
    <div class="separator"></div>
    ...
    @if ($pelamar->type == 'alumni' && $pelamar->alumni)
      <div class="d-flex flex-stack fs-4 py-3 mt-3">
        ...
        <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit">
          <a href="{{ route('user.pelamar.edit', [$pelamar, 'alumni']) }}" class="btn btn-sm btn-primary">Edit</a>
        </span>
      </div>
      <div class="separator"></div>

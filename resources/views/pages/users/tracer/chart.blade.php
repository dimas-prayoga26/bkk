<script>
    let alumniStats = {!! json_encode($alumniStats) !!};
    "use strict";
    var KTWidgets = {
        init: function() {
            ...
            ! function() {
                ...
                function o(e, t, a) {
                    var o = "",
                        s = "";
                    t - e < 100 || "Today" == a ? (o = "Today:", s = e.format("MMM D")) : "Yesterday" == a ? (
                        o = "Yesterday:", s = e.format("MMM D")) : s = e.format("MMM D") + " - " + t.format(
                        "MMM D"), $("#kt_dashboard_daterangepicker_date").html(s), $(
                        "#kt_dashboard_daterangepicker_title").html(o)
                }
            }(), (e = document.querySelector("#kt_user_menu_dark_mode_toggle")) && e.addEventListener("click", (
                    function() {
                        window.location.href = this.getAttribute("data-kt-url")
                    })), t = document.querySelectorAll(".statistics-widget-3-chart"), [].slice.call(t).map((
                    function(e) {
                ...
                }(), a = document.getElementById("kt_charts_widget_1_chart"), o = parseInt(KTUtil.css(a,
                    "height")), s = KTUtil.getCssVariableValue("--bs-gray-500"), r = KTUtil.getCssVariableValue(
                    "--bs-gray-200"), i = KTUtil.getCssVariableValue("--bs-primary"), l = KTUtil
                .getCssVariableValue("--bs-gray-300"), a && new ApexCharts(a, {
                    series: [{
                        name: "Jumlah",
                    ...
                    xaxis: {
                        categories: alumniStats.map(item => item['name']),
                        axisBorder: {
                            show: !1
                        },
                        axisTicks: {
                ...
                function() {
                    ...
                    [].slice.call(o).map((function(o) {
                        a = parseInt(KTUtil.css(o, "height")), e = KTUtil.getCssVariableValue(
                            "--bs-" + o.getAttribute("data-kt-color")), t = KTUtil.colorDarken(
                            e, 15), new ApexCharts(o, {
                            series: [{
                                name: "Net Profit",
                ...
                function() {
                    ...
                    [].slice.call(o).map((function(o) {
                        e = o.getAttribute("data-kt-color"), t = parseInt(KTUtil.css(o, "height")),
                            a = KTUtil.getCssVariableValue("--bs-" + e), new ApexCharts(o, {
                                series: [{
                                    name: "Net Profit",
                ...
                function() {
                ...
                }(), (n = document.querySelector("#kt_forms_widget_1_form")) && n && new Quill(
                    "#kt_forms_widget_1_editor", {
                        ...
                        theme: "snow"
                    }), c = document.querySelector("#kt_widget_5_load_more_btn"), d = document.querySelector(
                    "#kt_widget_5"), c && c.addEventListener("click", (function(e) {
                    e.preventDefault(), c.setAttribute("data-kt-indicator", "on"), setTimeout((
                    function() {
                        c.removeAttribute("data-kt-indicator"), d.classList.remove(
                            "d-none"), c.classList.add("d-none"), KTUtil.scrollTo(d, 200)
                    }), 2e3)
                })), (h = document.querySelector("#kt_user_follow_button")) && h.addEventListener("click", (
                    function(e) {
                        e.preventDefault(), h.setAttribute("data-kt-indicator", "on"), h.disabled = !0, h
                            .classList.contains("btn-success") ? setTimeout((function() {
                                h.removeAttribute("data-kt-indicator"), h.classList.remove(
                                        "btn-success"), h.classList.add("btn-light"), h
                                    .querySelector(".svg-icon").classList.add("d-none"), h
                                    .querySelector(".indicator-label").innerHTML = "Follow", h
                                    .disabled = !1
                            }), 1500) : setTimeout((function() {
                                h.removeAttribute("data-kt-indicator"), h.classList.add(
                                        "btn-success"), h.classList.remove("btn-light"), h
                                    .querySelector(".svg-icon").classList.remove("d-none"), h
                                    .querySelector(".indicator-label").innerHTML = "Following", h
                                    .disabled = !1
                            }), 1e3)
                    })),
                function() {

...
@section('content')
  ...
  @include('layouts.admin.header-main',['title' => 'Data Jurusan', 'subtitle' => 'Index'])
      ...
      <div class="card card-flush">
        <div class="card-header mt-3">
          <div class="card-title">
            <h3 class="fw-bolder">Data Jurusan</h3>
          </div>
          <div class="card-toolbar">

            {{-- Create --}}
            <a href="{{ route('manage.jurusan.create') }}" class="btn btn-sm btn-flex btn-primary fw-bolder px-4">
...
@section('js')
  @include('pages.manage.jurusan._indexscript')
@endsection

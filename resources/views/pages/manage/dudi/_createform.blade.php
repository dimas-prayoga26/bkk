<div class="row mb-4">
  ...
  <div class="col-lg-9 fv-row">
    <input type="text" name="name" id="name" class="form-control form-control-md mb-3 mb-lg-0 @error('name') is-invalid @enderror" placeholder="Ketik Nama DU/DI" value="{{ old('name') }}" required>
...
<div class="row mb-4">
  ...
  <div class="col-lg-9 fv-row">
    <input type="email" name="email" id="email" class="form-control form-control-md mb-3 mb-lg-0 @error('email') is-invalid @enderror" placeholder="Ketik Email" value="{{ old('email') }}" required>
...
<div class="row mb-4">
  ...
  <div class="col-lg-9 fv-row">
    <input type="text" name="telepon" id="telepon" class="form-control form-control-md mb-3 mb-lg-0 @error('telepon') is-invalid @enderror" placeholder="Ketik Telepon" value="{{ old('telepon') }}" required>
...
<div class="row mb-4">
  ...
  <div class="col-lg-9 fv-row">
    <input type="text" name="kota" id="kota" class="form-control form-control-md mb-3 mb-lg-0 @error('kota') is-invalid @enderror" placeholder="Ketik Kota DU/DI" value="{{ old('kota') }}" required>
    @error('kota') <span class="invalid-feedback">{{ $message }}</span> @enderror
  </div>
</div>
<div class="row mb-4">
  <label class="col-lg-3 col-form-label required fw-bold fs-6" for="alamat">Alamat</label>
  <div class="col-lg-9 fv-row">
  ...
  <div class="col-lg-9 fv-row">
    <div class=" align-items-center mt-lg-3">
      ...
      <label class="form-check form-check-custom form-check-solid mt-2">
        <input class="form-check-input h-20px w-20px" type="checkbox" name="jenis_kerjasama[]" value="{{ $item->id }}">
...
<div class="row mb-4">
  ...
  <div class="col-lg-9 fw-row">
    <div class="my-1">
      <img src="/img/logo/logo-dudi.jpg" alt="logo_dudi" class="img-fluid img-preview" style="width: 100px">
    </div>

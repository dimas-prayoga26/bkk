<div class="row mb-4">
  ...
  <div class="my-1">
    <img src="/img/tentang/{{ $tentang->cover }}" alt="cover" class="img-fluid img-preview" style="width: 300px">
  </div>
  <div class="col fv-row">
    <input type="hidden" name="old_cover" id="old_cover" value="{{ $tentang->cover }}">
...
<div class="row">
  <div class="col fv-row">
    ...
    <trix-editor input="isi">{!! $tentang->isi !!}</trix-editor>
  </div>

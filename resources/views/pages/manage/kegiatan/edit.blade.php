...
@section('content')
  ...
  @include('layouts.admin.header-sub',['title' => 'Data Kegiatan', 'subtitle' => 'Edit'])
      ...
      <div class="card card-flush">
        <div class="card-header mt-3">
          <div class="card-title">
            <h3 class="fw-bolder"> Edit Kegiatan </h3>
          </div>
        </div>
        <form action="{{ route('manage.kegiatan.update', $kegiatan->id) }}" method="POST" id="form-update">
        @csrf
        @method('PUT')

          <div class="card-body pt-2 border-top">
            <div class="mt-5">
              @include('pages.manage.kegiatan._editform')
            </div>
          </div>

...
@section('content')
  ...
  @include('layouts.admin.header-sub',['title' => 'Data Kegiatan', 'subtitle' => 'Create'])
      ...
      <div class="card card-flush">
        <div class="card-header mt-3">
          <div class="card-title">
            <h3 class="fw-bolder"> Tambah Kegiatan </h3>
          </div>
        </div>
        <form action="{{ route('manage.kegiatan.store') }}" method="POST" id="form-store">
        @csrf

          <div class="card-body pt-2 border-top">
            <div class="mt-5">
              @include('pages.manage.kegiatan._createform')
            </div>
          </div>

...
@section('content')
  ...
  @include('layouts.admin.header-sub',['title' => 'Data Kerjasama', 'subtitle' => 'Edit'])
  ...
  <div class="post d-flex flex-column-fluid" id="kt_post">
    <div id="kt_content_container" class="container-xxl">
      <div class="card card-flush">
        ...
        <form action="{{ route('manage.kerjasama.update', $kerjasama->id) }}" method="POST" id="form-update">
        @csrf
        @method('PUT')

          <div class="card-body pt-2 border-top">
            <div class="mt-5">
              @include('pages.manage.kerjasama._editform')
            </div>
          </div>

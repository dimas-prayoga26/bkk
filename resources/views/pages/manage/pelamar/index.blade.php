...
@section('content')
  ...
  @include('layouts.admin.header-main',['title' => 'Data Pelamar', 'subtitle' => 'Index'])
      ...
      <div class="card card-flush">
        <div class="card-header mt-3">
          <div class="card-title">
            <h3 class="fw-bolder">Data Pelamar</h3>
          </div>
          <div class="card-toolbar">

            {{-- Create --}}
            <a href="{{ route('manage.pelamar.create') }}" class="btn btn-sm btn-flex btn-primary fw-bolder px-4">
            ...
            <a href="{{ route('manage.pelamar.print') }}" class="btn btn-secondary btn-sm ms-2 me-0" target="_blank">
              Cetak
            </a>
            {{-- Filter --}}
            <div class="">
...
@section('js')
  @include('pages.manage.pelamar._indexscript')
@endsection

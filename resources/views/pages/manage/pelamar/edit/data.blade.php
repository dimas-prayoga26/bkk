@extends('pages.manage.pelamar.edit.index', ['subtitle' => 'Data'])
...
<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
  ...
  <form action="{{ route('manage.pelamar.update',[$pelamar, 'data']) }}" method="POST" id="update-profil">
  @csrf
  @method('PUT')
    ...
    <div class="card-body p-9">
      ...
      <div class="row mb-4">
        ...
        <div class="col-lg-9 fv-row">
          <select name="is_aktif" id="is_aktif" data-hide-search="true" data-kt-select2="true" data-placeholder="Pilih..." data-allow-clear="true" class="form-select form-select-md @error('is_aktif') is-invalid @enderror" required>
            <option></option>
            @foreach ([1,0] as $item)

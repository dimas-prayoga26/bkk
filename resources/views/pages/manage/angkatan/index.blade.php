...
@section('content')
  ...
  @include('layouts.admin.header-main',['title' => 'Data Angkatan', 'subtitle' => 'Index'])
      ...
      <div class="card card-flush">
        <div class="card-header mt-3">
          <div class="card-title">
            <h3 class="fw-bolder">Data Angkatan</h3>
          </div>
          <div class="card-toolbar">

            {{-- Create --}}
            <a href="{{ route('manage.angkatan.create') }}" class="btn btn-sm btn-flex btn-primary fw-bolder px-4">
          ...
          <table class="table align-middle table-striped table-hover fs-6 gy-2 mb-0" id="myTable">
            <thead>
              <tr class="text-start fw-bolder fs-7 text-uppercase gs-0 bg-dark text-white">
                <th class="ps-3">No.</th>
                <th class="">Tahun Angkatan</th>
                <th class="">Jumlah Alumni</th>
...
@section('js')
  @include('pages.manage.angkatan._indexscript')
@endsection

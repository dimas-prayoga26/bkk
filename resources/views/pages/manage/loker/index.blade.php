...
@section('content')
  ...
  @include('layouts.admin.header-main',['title' => 'Data Lowongan Kerja', 'subtitle' => 'Index'])
      ...
      <div class="card card-flush">
        <div class="card-header mt-3">
          <div class="card-title">
            <h3 class="fw-bolder">Data Lowongan Kerja</h3>
          </div>
          <div class="card-toolbar">

            {{-- Create --}}
            <a href="{{ route('manage.loker.create') }}" class="btn btn-sm btn-flex btn-primary fw-bolder px-4">
              ...
              <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61484bf845268">
                ...
                <div class="px-7 py-5">
                    ...
                    <div class="mb-10">
                      ...
                      <div>
                        <select class="form-select form-select-solid" data-hide-search="true" name="info" data-kt-select2="true" data-placeholder="Pilih..." data-dropdown-parent="#kt_menu_61484bf845268" data-allow-clear="true" id="info-select">
                          <option></option>
                          @foreach (['internal','eksternal'] as $item)
                            <option value="{{ $item }}">{{ $item == 'internal' ? 'Internal' : 'Eksternal' }}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                      ...
                      <div>
                        <select class="form-select form-select-solid" data-hide-search="true" name="status" data-kt-select2="true" data-placeholder="Pilih..." data-dropdown-parent="#kt_menu_61484bf845268" data-allow-clear="true" id="status-select">
                          ...
                          @foreach (['buka','tutup'] as $item)
                            <option value="{{ $item }}">{{ $item == 'buka' ? 'Dibuka' : 'Ditutup' }}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
...
@section('js')
  @include('pages.manage.loker._indexscript')
@endsection

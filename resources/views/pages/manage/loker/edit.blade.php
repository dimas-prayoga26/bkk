...
@section('content')
  ...
  @include('layouts.admin.header-sub',['title' => 'Data Lowongan Kerja', 'subtitle' => 'Edit'])
      ...
      <div class="card card-flush">
        <div class="card-header mt-3">
          <div class="card-title">
            <h3 class="fw-bolder"> Edit Lowongan Kerja </h3>
          </div>
        </div>
        <form action="{{ route('manage.loker.update', $loker->idt) }}" method="POST" id="form-update" enctype="multipart/form-data">
        @csrf
        @method('PUT')

          <div class="card-body pt-2 border-top">
            <div class="mt-5">
              @include('pages.manage.loker._editform')
            </div>
          </div>

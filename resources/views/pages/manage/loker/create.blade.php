...
@section('content')
  ...
  @include('layouts.admin.header-sub',['title' => 'Data Lowongan Kerja', 'subtitle' => 'Create'])
      ...
      <div class="card card-flush">
        <div class="card-header mt-3">
          <div class="card-title">
            <h3 class="fw-bolder"> Tambah Lowongan Kerja </h3>
          </div>
        </div>
        <form action="{{ route('manage.loker.store') }}" method="POST" id="form-store" enctype="multipart/form-data">
        @csrf

          <div class="card-body pt-2 border-top">
            <div class="mt-5">
              @include('pages.manage.loker._createform')
            </div>
          </div>

...
<div style="max-width: 140px;"><img alt="Your Logo" height="auto" src="{{ asset('img/logo/sekolah-logo.png') }}" style="display: block; height: auto; border: 0; width: 100%;" title="Your Logo" width="140"/></div>
</div>
</td>
</tr>
</table>
...
<h1 style="margin: 0; color: #ffffff; direction: ltr; font-family: 'Roboto Slab', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 30px; font-weight: normal; letter-spacing: 2px; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 36px;"><strong>FORGOT YOUR PASSWORD?</strong></h1>
</td>
</tr>
</table>
...
<td class="pad" style="width:100%;">
<div align="center" class="alignment" style="line-height:10px">
<div style="max-width: 500px;"><img alt="Wrong Password Animation" height="auto" src="{{ asset('images/GIF_password.gif') }}" style="display: block; height: auto; border: 0; width: 100%;" title="Wrong Password Animation" width="500"/></div>
</div>
</td>
</tr>
</table>
...
<div style="color:#3f4d75;font-family:Roboto Slab, Arial, Helvetica Neue, Helvetica, sans-serif;font-size:20px;line-height:120%;text-align:center;mso-line-height-alt:24px;">
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word;">Jangan khawatir</span></p>
</div>
</td>
</tr>
</table>
...
<tr>
<td class="pad" style="padding-bottom:5px;padding-left:10px;padding-right:10px;padding-top:5px;">
<div style="color:#3f4d75;font-family:Roboto Slab, Arial, Helvetica Neue, Helvetica, sans-serif;font-size:22px;line-height:120%;text-align:center;mso-line-height-alt:26.4px;">
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word;">Ayo buatkan kata sandi baru untukmu.</span></p>
</div>
</td>
</tr>
</table>
...
<tr>
<td class="pad">
<div style="color:#3f4d75;font-family:Roboto Slab, Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
<p style="margin: 0; word-break: break-word;"><span style="word-break: break-word;">Jika Anda tidak meminta perubahan kata sandi, abaikan saja email ini.</span></p>
</div>
</td>
</tr>
</table>
...
<tr>
<td style="padding:0 10px 0 10px;"><a href="https://www.facebook.com" target="_blank"><img alt="Facebook" height="auto" src="{{ asset('images/facebook2x.png') }}" style="display: block; height: auto; border: 0;" title="facebook" width="32"/></a></td>
<td style="padding:0 10px 0 10px;"><a href="https://www.twitter.com" target="_blank"><img alt="Twitter" height="auto" src="{{ asset('images/twitter2x.png') }}" style="display: block; height: auto; border: 0;" title="twitter" width="32"/></a></td>
<td style="padding:0 10px 0 10px;"><a href="https://www.instagram.com" target="_blank"><img alt="Instagram" height="auto" src="{{ asset('images/instagram2x.png') }}" style="display: block; height: auto; border: 0;" title="instagram" width="32"/></a></td>
<td style="padding:0 10px 0 10px;"><a href="https://www.youtube.com" target="_blank"><img alt="Linkedin" height="auto" src="{{ asset('images/youtube.png') }}" style="display: block; height: auto; border: 0;" title="linkedin" width="32"/></a></td>
</tr>
</table>
</div>
</td>
...
<div align="center" class="alignment" style="line-height:10px">
<div style="max-width: 130px;"><img alt="Your Logo" height="auto" src="{{ asset('img/logo/sekolah-logo.png') }}" style="display: block; height: auto; border: 0; width: 100%;" title="Your Logo" width="130"/></div>
</div>
</td>
</tr>
</table>
